...
export function createProductionStartupBinding(
  ...
  for (const [value, label] of [
    ...
    [platform === "darwin" ? ports?.app?.isInApplicationsFolder : () => false, "electron.app.isInApplicationsFolder()."],
    [platform === "darwin" ? ports?.app?.moveToApplicationsFolder : () => false, "electron.app.moveToApplicationsFolder()."],
